...
### 2D
```{r}
plot_ly(proj,x=~x,y=~y,color =~label,type ='scatter',text=~label) #3d
```

### 3D
```{r}
plot_ly(proj,x=~x,y=~y,z=~z,color =~label,type ='scatter3d',text=~label) #3d
```
